...
# 測試加入排隊因 餐廳找不到 而失敗
def test_join_restaurant_waiting_queue_notFound(queue_service, mock_repos):
    # Arrange
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
...
def test_join_restaurant_waiting_queue_alreadyInQueue(queue_service, mock_repos):
    # Arrange
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
...
""""""
# 測試離開排隊成功案例
def test_leave_restaurant_waiting_queue_success(queue_service, mock_repos):
    # Arrange
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
...
# 測試離開排隊因 不在排隊隊伍中 而失敗
def test_leave_queue_notInAnyQueue(queue_service, mock_repos):
    # Arrange
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
...
def test_leave_queue_notInCorrectQueue(queue_service, mock_repos):
    # Arrange
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
...
# 測試離開排隊因 餐廳找不到 而失敗
def test_leave_queue_restaurant_notFound(queue_service, mock_repos):
    # Act & Assert
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
...
def test_get_queue_status_success(queue_service, mock_repos):
    ...
    mock_queue_runtime_repo.get_metrics.return_value = (10, 2)  # avg_dining_time, total_seats
...
# 測試取得排隊狀態因 餐廳找不到 而失敗
def test_get_queue_status_restaurant_not_found(queue_service, mock_repos):
    # Arrange
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
...
# 測試取得餐廳叫號因 餐廳找不到 而失敗
def test_get_queue_next_restaurant_not_found(queue_service, mock_repos):
    # Arrange
    mock_queue_repo, mock_queue_runtime_repo, mock_map_repo = mock_repos
